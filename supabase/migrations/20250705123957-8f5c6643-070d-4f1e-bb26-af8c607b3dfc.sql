...
INSERT INTO public.interactive_stories (id, title, description, cover_url, difficulty_level, estimated_time, category, age_range) VALUES
('story-haunted-house', 'خانه تسخیر شده', 'ماجراجویی ترسناک در خانه‌ای مرموز پر از راز و رمز', '/placeholder.svg', 'متوسط', 20, 'ترسناک', '12+ سال'),
('story-fantasy-adventure', 'ماجراجویی افسانه‌ای', 'سفری جادویی به سرزمین اژدهاها و جادوگران', '/placeholder.svg', 'سخت', 25, 'فانتزی', '10+ سال'),
('story-space-journey', 'سفر فضایی', 'کاوش در کهکشان‌های دور و کشف حیات در فضا', '/placeholder.svg', 'آسان', 15, 'علمی-تخیلی', '8+ سال'),
('story-detective-mystery', 'راز کارآگاه', 'حل یک پرونده مرموز در شهری پر از اسرار', '/placeholder.svg', 'سخت', 30, 'جنایی', '14+ سال');